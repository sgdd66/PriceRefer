...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(802, 698)
        MainWindow.setUnifiedTitleAndToolBarOnMac(False)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.tabWidget = QtWidgets.QTabWidget(self.centralwidget)
        self.tabWidget.setGeometry(QtCore.QRect(80, 230, 641, 341))
        ...
        self.widget.setGeometry(QtCore.QRect(30, 30, 571, 191))
        ...
        self.comboBox_board9 = QtWidgets.QComboBox(self.widget)
        ...
        self.comboBox_board7 = QtWidgets.QComboBox(self.widget)
        ...
        self.comboBox_board8 = QtWidgets.QComboBox(self.widget)
        ...
        self.comboBox_board6 = QtWidgets.QComboBox(self.widget)
        ...
        self.widget1.setGeometry(QtCore.QRect(70, 70, 511, 151))
        ...
        self.comboBox_board2 = QtWidgets.QComboBox(self.widget1)
        ...
        self.comboBox_board1 = QtWidgets.QComboBox(self.widget1)
        ...
        self.widget2.setGeometry(QtCore.QRect(50, 50, 551, 211))
        ...
        self.comboBox_board3 = QtWidgets.QComboBox(self.widget2)
        ...
        self.comboBox_board4 = QtWidgets.QComboBox(self.widget2)
        ...
        self.radioButton_board4_0 = QtWidgets.QRadioButton(self.widget2)
        self.radioButton_board4_0.setChecked(True)
        ...
        self.radioButton_board4_1 = QtWidgets.QRadioButton(self.widget2)
        ...
        self.radioButton_board4_2 = QtWidgets.QRadioButton(self.widget2)
        ...
        self.comboBox_board5 = QtWidgets.QComboBox(self.widget2)
        ...
        self.buttonGroup2=QtWidgets.QButtonGroup(self.widget2)
        self.radioButton_board5_1 = QtWidgets.QRadioButton(self.widget2)
        ...
        self.radioButton_board5_2 = QtWidgets.QRadioButton(self.widget2)
        ...
        self.pushButton_calculate.setGeometry(QtCore.QRect(530, 610, 93, 28))
        self.pushButton_calculate.setObjectName("pushButton_calculate")
        self.widget3 = QtWidgets.QWidget(self.centralwidget)
        self.widget3.setGeometry(QtCore.QRect(80, 40, 641, 161))
        ...
        self.lineEdit_P_in = QtWidgets.QLineEdit(self.widget3)
        ...
        self.lineEdit_T_in = QtWidgets.QLineEdit(self.widget3)
        ...
        self.lineEdit_P = QtWidgets.QLineEdit(self.widget3)
        ...
        self.lineEdit_Qn = QtWidgets.QLineEdit(self.widget3)
        ...
        self.lineEdit_n = QtWidgets.QLineEdit(self.widget3)
        self.lineEdit_n.setObjectName("lineEdit_n")
        self.gridLayout.addWidget(self.lineEdit_n, 2, 1, 1, 1)
        self.isSingle = QtWidgets.QCheckBox(self.widget3)
        self.isSingle.setObjectName("isSingle")
        self.gridLayout.addWidget(self.isSingle, 2, 2, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.isSingle.setText(_translate("MainWindow", "单吸"))
